<template>
  <div class="product-slider">
    <div class="image-slider">
      <div class="slider-container">
        <div class="slider ">
          <transition name="fade" mode="out-in">
            <div class="slide" :key="currentIndex" v-if="coats.images">
              <img :src="coats.images[currentIndex]"  alt="Slider Image">
            </div>
          </transition>
      ...
      <div class="dots">
        <span v-for="(image, index) in coats.images" v-if="coats.images" :key="index" @click="goToSlide(index)"
...
export default {
  ...
  mounted(){
console.log('sliderCoats',this.coats )
  },
  data() {
    return {
      currentIndex: 0,
...
.slide {
  ...
  text-align: center;
  /* If you need to center-align text within the slide */
}
...
img {
  ...
  height: auto;
  max-height: 100vh;
  /* Limit the height of the image to the viewport */
}
